...
const NAV = [
  ...
  { href: "/learner", label: "Learner resources" },
  { href: "/impound", label: "Collection documents" },
];

const HELP_NAV = [
  { href: "/help-support", label: "Help & Support" },
  { href: "/retrieve-policy", label: "Existing documents" },
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/85 backdrop-blur-xl">
      ...
      {open && (
        <div
          id="mobile-menu"
          className="absolute left-0 right-0 top-full z-[60] max-h-[calc(100dvh-76px)] overflow-y-auto overscroll-contain border-t border-slate-200/80 bg-white/96 backdrop-blur-xl xl:hidden"
        >
