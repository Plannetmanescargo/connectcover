...
const resources: readonly ResourceCard[] = [
  {
    title: "FAQs",
    desc: "Clear answers on scope, compatibility, document delivery and revisions.",
    href: "/more/faq",
    label: "FAQs",
    icon: <IconSpark />,
    bullets: [
  ...
  {
    title: "Blog",
    desc: "Useful perspectives on technical information, clear documents and version control.",
    href: "/more/blog",
    label: "Insights",
    icon: <IconDoc />,
    bullets: ["Explainers", "Updates", "Version notes"],
    accent: "indigo",
    status: "live",
  },
] as const;
...
const browseByProduct = [
  { title: "Car documents", href: "/car" },
  { title: "Van documents", href: "/van" },
  { title: "Learner resources", href: "/learner" },
  { title: "Collection documents", href: "/impound" },
] as const;
    ...
    >
      ...
      <section className="pt-2 sm:pt-4 lg:pt-6">
        <div className="max-w-[76rem]">
          ...
          <p className="mt-10 max-w-[54rem] text-[1.02rem] leading-8 text-slate-600 sm:text-[1.14rem]">
            Browse answers, practical guides and thoughtful reads. Understand
            the documents, the technical detail and what to check before you
            begin.
          </p>
      ...
      <section className="mt-16">
        <div className="max-w-[56rem]">
          ...
          <p className="mt-4 max-w-[44rem] text-[1.02rem] leading-8 text-slate-600 sm:text-[1.08rem]">
            Explore car and van documents, learner resources or supporting
            information for a collection enquiry.
          </p>
        </div>
      ...
      <section className="mt-16">
        <div className="max-w-[56rem]">
          ...
          <p className="mt-4 max-w-[44rem] text-[1.02rem] leading-8 text-slate-600 sm:text-[1.08rem]">
            Explore practical content across FAQs, guides and articles, with
            each route built to stay clean and easy to follow.
          </p>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
            <div className="min-w-0">
              ...
              <h2 className="mt-3 max-w-[16ch] text-[1.9rem] font-extrabold leading-[0.96] tracking-[-0.045em] text-slate-950 sm:text-[2.35rem]">
                Support and document access, kept simple
              </h2>

              <p className="mt-4 max-w-[38rem] text-[1rem] leading-8 text-slate-600">
                If you need help with the scope or delivery of a document, start
                with the help centre. Existing customers can also use the
                retrieval journey.
              </p>
