    ...
    >
      ...
      <section className="pt-2 sm:pt-4 lg:pt-6">
        <div className="max-w-[76rem]">
          ...
          <p className="mt-10 max-w-[54rem] text-[1.02rem] leading-8 text-slate-600 sm:text-[1.14rem]">
            Access existing documents, check a compatibility question or ask
            about delivery and revisions. Find a clear next step for your
            enquiry.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-x-7 gap-y-3 text-sm font-medium text-slate-700">
            {["Clear next steps", "Document access", "Support when needed"].map(
              (item) => (
      ...
      <section className="mt-16">
        <div className="max-w-[56rem]">
          ...
          <p className="mt-4 max-w-[44rem] text-[1.02rem] leading-8 text-slate-600 sm:text-[1.08rem]">
            Most customers come here to retrieve documents, check a common
            question, or get in touch with support.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          <ActionCard
            ...
            desc="Use the existing customer retrieval journey to access previously issued documents."
            href="/retrieve-policy"
            cta="Existing documents"
            featured
            icon={<IconDoc />}
          />
          ...
          <ActionCard
            ...
            desc="Find clear answers on scope, compatibility, delivery and revisions."
            href="/more/faq"
            cta="Open FAQs"
            icon={<IconQuestion />}
          />
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
            <div className="min-w-0">
              ...
              <h2 className="mt-3 max-w-[16ch] text-[1.9rem] font-extrabold leading-[0.96] tracking-[-0.045em] text-slate-950 sm:text-[2.35rem]">
                Help with scope, documents and delivery
              </h2>

              <p className="mt-4 max-w-[38rem] text-[1rem] leading-8 text-slate-600">
                If something looks unclear, start with retrieval or the FAQs. If
                you still need a hand, our support team is easy to reach.
              </p>
            ...
            <div className="rounded-[1.4rem] border border-slate-200/80 bg-white/84 p-5">
              ...
              <div className="mt-4 grid gap-3">
                {[
                  ...
                  "Understanding scope and revisions",
                ].map((item) => (
                  <div
                    key={item}
      ...
      <section className="mt-16">
        ...
        <div className="mt-8 rounded-[1.8rem] border border-slate-200/80 bg-white/88 px-6 py-2 shadow-sm sm:px-8">
          <FaqItem
            question="How will my documents arrive?"
            answer="Documents are delivered electronically using the method agreed for your order. Check the service description for the format and delivery timeframe."
          />

          <FaqItem
            question="How do I check compatibility?"
            answer="Share the make, model, year and relevant equipment or software version. A model name alone does not confirm that a guide applies."
          />

          <FaqItem
            question="Can I request a revision?"
            answer="Contact support with the document version and the change you need. Included revisions depend on the agreed scope of your order."
          />

          <FaqItem
            question="How do I access an existing document?"
            answer={
              <>
                Use the{" "}
                ...
                page with your existing reference, or contact support for help
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mx-auto mt-5 max-w-[38rem]">
              <p className="text-center text-[1.02rem] leading-8 text-slate-600 sm:text-[1.08rem]">
                Start with your original delivery message. Existing customers
                can use retrieval; contact support if a document or link is
                unavailable.
              </p>
            </div>
